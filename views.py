...
#         stage_name = current_status.stage.name  # أو استخدم str(current_status.stage)
...
#                 is_public=False,
#                 group=None  # لا يتم ربطه بمجموعة
#             )
...
#         'groups': groups,
#         'stages': stages,
#         'selected_stage_id': int(stage_id) if stage_id else None
#     })
